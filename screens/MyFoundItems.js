...
const MyFoundItems = () => {
  ...
  return (
    <View style={styles.myFoundItems}>
      <Image
      ...
      />
      <Text style={[styles.myFoundItems1, styles.back1Typo]}>
        My Found Items
      </Text>
      <Image
      ...
      <Text style={[styles.sunglassesRaybanColorContainer, styles.back1Typo]}>
        <Text style={[styles.sunglasses, styles.back1Typo1]}>{`Sunglasses
`}</Text>
        <Text style={styles.raybanColorBlue}>{`Rayban, color blue with case
`}</Text>
      </Text>
      <View style={[styles.myFoundItemsChild, styles.foundBorder]} />
      <TextInput style={[styles.myFoundItemsItem, styles.foundBorder]} />
...
const styles = StyleSheet.create({
  ...
  sunglassesRaybanColorContainer: {
    top: 296,
    width: 251,
    height: 63,
    left: 24,
